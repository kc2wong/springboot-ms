...
configure<PublishingExtension> {
	publications {
		create<MavenPublication>("maven") {
			artifactId = "market-data-restclient"
...
openApiGenerate {
	...
	apiPackage.set("com.exiasoft.its.mktdata.endpoint.rest.api")
	modelPackage.set("com.exiasoft.its.mktdata.endpoint.rest.model")
	invokerPackage.set("com.exiasoft.its.mktdata")
